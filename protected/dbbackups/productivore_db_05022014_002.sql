...
INSERT INTO `settings` VALUES (1,1,2,1),(2,1,5,2),(4,8,1,1),(5,8,5,2);
...
INSERT INTO `user_appling_maps` VALUES (1,1,0,0,0,'\0'),(2,1,1,0,0,'\0'),(3,1,2,0,0,'\0'),(4,1,3,0,0,'\0'),(5,1,4,0,0,'\0'),(8,2,0,0,0,'\0'),(9,2,1,0,0,'\0'),(10,2,2,0,0,'\0'),(11,2,3,0,0,'\0'),(12,2,4,0,0,'\0');
...
INSERT INTO `users` VALUES (1,'crentagon','crentagon@gmail.com','sha256:1000:DvYyGF5N0lrfY0SEKfp8YyqeRdyJa4/A:WAk9TqASC0ZLBSaBWEy0fIJtHWvuYm2J'),(2,'awesomenite','ask.awesomenite.dragonite@gmail.com','sha256:1000:xqfMjTeDCaB4tFa+TosuhnI2eZX+RUo2:s/DsYdlXLok5fkasZ/0WNRMzBtJVhBP2');
...
--
-- Dumping events for database 'productivore_db'
--

--
-- Dumping routines for database 'productivore_db'
--
...
-- Dump completed on 2014-05-02 17:08:20
