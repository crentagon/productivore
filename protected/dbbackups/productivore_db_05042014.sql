...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Those stuff in the navbar.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `menus` VALUES (1,'Home','index',0,NULL),(2,'Appling Manager','applings',0,NULL),(3,'Achievements','achievements',4,NULL),(4,'Anticipate','anticipate',4,NULL),(5,'Lessons','lessons',4,NULL),(6,'My Profile','selfdiscovery',4,NULL);
...
INSERT INTO `setting_field_setting_value_maps` VALUES (1,0,1,1,1),(2,0,1,2,0),(3,0,1,3,0),(4,0,2,4,1),(5,0,2,5,0),(6,0,1,6,0);
...
INSERT INTO `settings` VALUES (1,1,6,1),(2,1,5,2),(4,8,1,1),(5,8,5,2),(7,15,1,1),(8,15,4,2);
...
INSERT INTO `user_appling_maps` VALUES (1,1,0,0,0,'\0'),(2,1,1,555,0,''),(3,1,2,55,0,'\0'),(4,1,3,5,0,'\0'),(5,1,4,0,0,''),(8,2,0,0,0,'\0'),(9,2,1,0,0,'\0'),(10,2,2,0,0,'\0'),(11,2,3,0,0,'\0'),(12,2,4,0,0,'\0'),(15,3,0,0,0,'\0'),(16,3,1,0,0,'\0'),(17,3,2,0,0,'\0'),(18,3,3,0,0,'\0'),(19,3,4,0,0,'\0');
...
INSERT INTO `users` VALUES (1,'crentagon','crentagon@gmail.com','sha256:1000:yluOkCnJGP6xdMUtwT6/q5MK9Gc16d1f:LzHInQ9CP2RSS5Gw0lh8X9AGAcWXAzo4'),(2,'awesomenite','ask.awesomenite.dragonite@gmail.com','sha256:1000:xqfMjTeDCaB4tFa+TosuhnI2eZX+RUo2:s/DsYdlXLok5fkasZ/0WNRMzBtJVhBP2'),(3,'guest001','guest001@guest.com','sha256:1000:AGdiV3fHWDXw4XRM7vcb/vj9wgiMfLLe:sJzTc40kMhOzifw/7QcqddMAAuUtadej');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`crentaroot`@`localhost`*/ /*!50003 TRIGGER `users_AINS` AFTER INSERT ON `users` FOR EACH ROW
BEGIN
...
-- Dump completed on 2014-05-05  0:48:38
